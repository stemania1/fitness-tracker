...
describe("TrainingPlanTodayCard", () => {
  ...
  it("shows no readiness gate when the score is unavailable", () => {
    renderAt("2026-08-08T08:00:00", null)
